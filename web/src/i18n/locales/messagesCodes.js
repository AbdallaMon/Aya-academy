...
const ar = {
  ...
  [messagesNames.authMessages]: {
    ...
    [authMessagesCodes.RESET_EMAIL_SENT]: "إذا كان لديك حساب، فقد أرسلنا رابط إعادة تعيين كلمة المرور إلى بريدك",
    [authMessagesCodes.PASSWORD_RESET_SUCCESS]: "تم تغيير كلمة المرور بنجاح، يمكنك تسجيل الدخول الآن",
    [authMessagesCodes.RESET_TOKEN_INVALID]: "رابط إعادة التعيين غير صالح أو منتهي الصلاحية",
    [authMessagesCodes.RESET_TOKEN_REQUIRED]: "رمز إعادة التعيين مطلوب",
    [authMessagesCodes.RESET_RATE_LIMITED]: "محاولات كثيرة، برجاء المحاولة بعد قليل",
...
const en = {
  ...
  [messagesNames.authMessages]: {
    ...
    [authMessagesCodes.RESET_EMAIL_SENT]: "If you have an account, we've sent a password reset link to your email",
    [authMessagesCodes.PASSWORD_RESET_SUCCESS]: "Your password has been changed — you can sign in now",
    [authMessagesCodes.RESET_TOKEN_INVALID]: "This reset link is invalid or has expired",
    [authMessagesCodes.RESET_TOKEN_REQUIRED]: "Reset token is required",
    [authMessagesCodes.RESET_RATE_LIMITED]: "Too many attempts, please try again shortly",
