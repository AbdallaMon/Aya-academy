...
export const gamesData = {
  ar: {
    ...
    noAssignedGames: "مفيش ألعاب مسندة لك لسه.. كلّم معلّمك يبعتلك ألعاب حلوة! 🎮💛",
    ...
    certBody: "تشهد أكاديمية آية بأن بطلنا المبدع تعلّم وأتقن جميع الآداب الجميلة!",
