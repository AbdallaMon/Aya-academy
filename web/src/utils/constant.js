...
import { DEFAULT_PAGE_SIZE as SHARED_DEFAULT_PAGE_SIZE, PAGE_SIZE_OPTIONS as SHARED_PAGE_SIZE_OPTIONS } from "@aya/shared";
import { stripLocale } from "../i18n/routing.js";

export const DEFAULT_PAGE_SIZE = SHARED_DEFAULT_PAGE_SIZE ?? 10;
export const PAGE_SIZE_OPTIONS = SHARED_PAGE_SIZE_OPTIONS ?? [10, 25, 50, 100];
