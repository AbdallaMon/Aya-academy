...
export const invoiceMessagesCodes = {
  ...
  INVOICE_REBILLED_AND_SUBSCRIPTION_PAUSED:
    "INVOICE_REBILLED_AND_SUBSCRIPTION_PAUSED",
  INVOICE_UPDATED: "INVOICE_UPDATED",
  INVALID_STATUS_TRANSITION: "INVOICE_INVALID_STATUS_TRANSITION",
  INVOICE_SENT: "INVOICE_SENT",
  INVOICE_SEND_FAILED: "INVOICE_SEND_FAILED",
  // Send blocked: the student has no linked parent to deliver the invoice to.
  NO_PARENT_LINKED: "INVOICE_NO_PARENT_LINKED",
