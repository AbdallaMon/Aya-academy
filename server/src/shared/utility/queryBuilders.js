// ===========================================================================
// queryBuilders — list-query builders (search / filter / active / date-range /
// order). API shape ported from the reference (school-system / Transaction-app)
// so repos build `where` the same way everywhere. All pure functions (no I/O).
//
